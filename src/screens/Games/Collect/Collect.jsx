    ...
    <div>
      ...
      <label class="form-control">
        <input
          ...
          checked={isTropical}
          onChange={() => {
            isTropical ? setIsTropical(null) : setIsTropical("isTropical");
          }}
        />
        Tropical
      </label>
      ...
      <label class="form-control">
        <input
          ...
          checked={isReddish}
          onChange={() => {
            isReddish ? setIsReddish(null) : setIsReddish("isReddish");
          }}
        />
        Reddish
      </label>
      <br />
      <p className="quest">In which part of the body is the rash present?</p>
      <label class="form-control">
        <input
          type="checkbox"
          name="checkbox"
      ...
      <label class="form-control">
        <input
          ...
          checked={isGenital}
          onChange={() => {
            isGenital ? setIsGenital(null) : setIsGenital("isGenital");
          }}
        />
        Genital Area
      </label>
      ...
      <br />
      <p className="quest">Did the rash spread to other parts of the body?</p>
      <label class="form-control">
        <input
          type="checkbox"
          name="checkbox"
      ...
      <label class="form-control">
        <input
          ...
          checked={isPainful}
          onChange={() => {
            isPainful ? setIsPainful(null) : setIsPainful("isPainful");
          }}
        />
        Yes
      </label>
